...
In hosted-trial mode, the welcome page identifies the author and official repository,
links directly to self-hosting documentation, and explains the demo's limits. Semantic
